...
public class IoTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IoTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionInputTypeAccess().getAlternatives(), "rule__FunctionInputType__Alternatives");
			...
			builder.put(grammarAccess.getFunctionInputTypeAccess().getGroup_0(), "rule__FunctionInputType__Group_0__0");
			builder.put(grammarAccess.getFunctionInputTypeAccess().getGroup_1(), "rule__FunctionInputType__Group_1__0");
			builder.put(grammarAccess.getFunctionInputTypeAccess().getGroup_2(), "rule__FunctionInputType__Group_2__0");
			...
			builder.put(grammarAccess.getModelAccess().getFunctionAssignment_2(), "rule__Model__FunctionAssignment_2");
			builder.put(grammarAccess.getModelAccess().getAbstractBoardAssignment_3(), "rule__Model__AbstractBoardAssignment_3");
			builder.put(grammarAccess.getModelAccess().getBoardAssignment_4(), "rule__Model__BoardAssignment_4");
			...
			builder.put(grammarAccess.getFunctionInputTypeAccess().getValueAssignment_0_2(), "rule__FunctionInputType__ValueAssignment_0_2");
			builder.put(grammarAccess.getFunctionInputTypeAccess().getValueAssignment_1_2(), "rule__FunctionInputType__ValueAssignment_1_2");
			builder.put(grammarAccess.getFunctionInputTypeAccess().getValueAssignment_2_2(), "rule__FunctionInputType__ValueAssignment_2_2");
